...
async function Button() {
    ...
    document.write(await JSON.stringify(dirStructObj))
}
...
//     console.log(getDirStruct_as_JSON(dirHandle))
// }
// async function getDirStruct(dir) {
//     let info = {
//         path: '',
...
//             info.sub_items.push(getDirStruct(subEntry))
//             Promise.all(info.sub_items).then((values) => {
//                 info.sub_items = JSON.parse(JSON.stringify(values))   
//                 //info.sub_items.push(values)
//             })
//         }
//     } else {
...
//         info.type = name.substring(name.lastIndexOf(".") + 1)
//     }
//     return await JSON.parse(JSON.stringify(info))
//     //return info
// }
